...
mod market_place {
    ...
    mod tests {
        ...
        #[ink::test]
        fn default_works() {
            let market_place = MarketPlace::default();
        ...
        #[ink::test]
        fn it_works() {
            let mut market_place = MarketPlace::new(false);
            assert_eq!(market_place.get(), false);
            market_place.flip();
    ...
    mod e2e_tests {
        ...
        async fn default_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            // When
            let contract = client
                .instantiate("market_place", &ink_e2e::alice(), &mut constructor)
                .submit()
                .await
        ...
        async fn it_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let contract = client
                .instantiate("market_place", &ink_e2e::bob(), &mut constructor)
                .submit()
                .await
                .expect("instantiate failed");
